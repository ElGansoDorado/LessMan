...
export default function Settings() {
    ...
    const handleFormSubmit = (evt: React.FormEvent<HTMLFormElement>) => {
        ...
        submit({ photo, name, desc, telegram, instagram },
    ...
    return (<form onSubmit={handleFormSubmit}>
        ...
        <div>
            ...
            <input type="text" placeholder='des' value={desc} onChange={(evt) => setDesc(evt.target.value)} />
            <input type="text" placeholder='te' value={telegram} onChange={(evt) => setTelegram(evt.target.value)} />
            <input type="text" placeholder='ins' value={instagram} onChange={(evt) => setInstagram(evt.target.value)} />
            <input
                type="submit"
